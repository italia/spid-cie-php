...
class EntityDescriptor extends SignedElementHelper
{
    ...
    /**
     * Namespaces to add to EntityDescriptor
     *
     * @var array
     */
    private $ns = [];
    ...
    public function __construct(DOMElement $xml = null)
    {
        ...
        // get spid namespace if exists
        if($xml->hasAttribute('xmlns:spid')) {
    ...
    /**
     * Collect the value of the namespaces.
     *
     * @return string
     */
     ...
     /**
      * Set the value of the namespaces
      * @param string $ns
      * @param string $val
      * @return void
      */ 
     public function setNamespace(string $ns, string $val) : void
     {
         $this->ns[$ns] = $val;
     }
