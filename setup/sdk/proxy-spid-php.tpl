...
class PROXY_SPID_PHP extends SPID_PHP {
    ...
    public function __construct($client_id, $redirect_uri, $state='') {
        parent::__construct();
    ...
    public function addSPIDButtonListItems(): string{
        $button_li = "
                ...
                <li class=\"spid-idp-button-link\" data-idp=\"spiditalia\">
                    <a href=\"/proxy-spid.php?client_id=".$this->client_id."&action=login&redirect_uri=".$this->redirect_uri."&idp=Register.it S.p.A.&state='.$this->state.'\"><span class=\"spid-sr-only\">SPIDItalia Register.it</span><img src=\"/{{SERVICENAME}}/spid-sp-access-button/img/spid-idp-spiditalia.svg\" onerror=\"this.src='/{{SERVICENAME}}/spid-sp-access-button/img/spid-idp-spiditalia.png'; this.onerror=null;\" alt=\"SpidItalia\" /></a>
                </li>
